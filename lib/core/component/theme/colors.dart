...
class StandartColors {
  ...
  static Color suvaGrey = HexColor.getHexColor('#929292');
  static Color purpleHeart = HexColor.getHexColor('#4631D2');
  static Color amaranth = HexColor.getHexColor('#EC3A4D');
}
